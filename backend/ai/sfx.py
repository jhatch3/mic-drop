...
CATALOG: dict[str, tuple[str, float]] = {
    "game_show_open": (
        "short punchy game show opening sting, bright triumphant brass stab with sparkle, "
        "quick exciting showtime intro, no long tail",
        2.5,
    ),
    ...
    "victory": (
        "epic triumphant victory fanfare: bright brass horns and a regal trumpet hit, a big "
        "celebratory drum roll into a cymbal crash, sparkling bubbly chimes, game-level-complete "
        "stinger, huge winning moment",
        4.0,
    ),
    "scoring_music": (
