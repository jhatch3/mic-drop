...
Prerequisites:
    - reference poses JSON from assets/dances/references/ (generated by extract_poses.py)
...
def main() -> None:
    ...
    parser.add_argument("--ref", type=Path, default=Path("../../assets/dances/references/reference_poses.json"), help="Path to reference poses JSON")
